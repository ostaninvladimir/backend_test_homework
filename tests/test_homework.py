...
def test_Training():
    assert inspect.isclass(homework.Training), "Проверьте, что `Training` - это класс."
...
def test_Swimming():
    ...
    assert inspect.isclass(homework.Swimming), "Проверьте, что `Swimming` - это класс."
    assert issubclass(
...
def test_Running():
    ...
    assert inspect.isclass(homework.Running), "Проверьте, что `Running` - это класс."
    assert issubclass(
