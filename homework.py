...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        return cal_run * self.weight / self.M_IN_KM * self.duration * self.HOUR_IN_MIN
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        return cal_wlk_3 * self.duration * self.HOUR_IN_MIN
...
class Swimming(Training):
    ...
    def get_mean_speed(self) -> float:
        ...
        return mean_speed_swm / self.M_IN_KM / self.duration

    def get_spent_calories(self) -> float:
        """Получить количество затраченных калорий."""
        cal_swm = self.get_mean_speed() + self.swim_coeff_1
        return cal_swm * self.swim_coeff_2 * self.weight
